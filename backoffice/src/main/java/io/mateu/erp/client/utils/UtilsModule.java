...
public class UtilsModule extends AbstractModule {
    ...
    public List<MenuEntry> buildMenu() {
        ...
        m.add(new AbstractAction("Populate with test data") {
            @Override
            public void run() {
                ((ERPServiceAsync)MateuUI.create(ERPService.class)).runInServer(MateuUI.getApp().getUserData(),"io.mateu.erp.tests.TestPopulator", "populateEverything", null, null, null, new AsyncCallback<Object>() {
                    @Override
