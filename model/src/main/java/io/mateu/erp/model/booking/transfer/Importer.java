                ...
                try {
                    ...
                    if (ref == null) pw.println("<span style='color: red;'>line " + nofila + ": missing ref</span>");
                        ...
                        if (s != null) {
                            ...
                            pw.println("line " + nofila + ": pickup time for service id " + id + " setted to " + s.getPickupTime().format(dtf));
                        } else {
                            pw.println("<span style='color: red;'>line " + nofila + ": no service with id " + ref + "</span>");
                        }
