...
public class InventoryCalendarNavigator extends HorizontalLayout {

    private final Label titulo;
    private final InventoryCalendar calendario;
    ...
    public InventoryCalendarNavigator(InventoryCalendar calendario) {
