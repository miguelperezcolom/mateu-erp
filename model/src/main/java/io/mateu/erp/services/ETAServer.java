...
*/
    ...
    public static HttpServer startServer() {
        ...
        final ResourceConfig rc = new ResourceConfig(CommonsServiceImpl.class, ActivityBookingServiceImpl.class, TransferBookingServiceImpl.class, HotelBookingServiceImpl.class, CircuitBookingServiceImpl.class, GenericBookingServiceImpl.class, ChannelManagerServiceImpl.class, StatsResource.class);
