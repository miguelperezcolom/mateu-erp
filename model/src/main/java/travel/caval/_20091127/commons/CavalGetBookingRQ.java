...
/**
 * <p>Clase Java para cavalGetBookingRQ complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="cavalGetBookingRQ"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "cavalGetBookingRQ", propOrder = {
    "locator"
})
public class CavalGetBookingRQ
