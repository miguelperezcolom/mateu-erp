        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="dinA5">
                ...
                <fo:flow flow-name="xsl-region-body" >
                    ...
                    <xsl:if test="not(services/service)">
                        <fo:block>NO SERVICE</fo:block>
                    </xsl:if>
                    ...
                    <xsl:for-each select="services/service">
                        ...
                        <xsl:choose>
                            <xsl:when test="@status">
                                ...
                                <fo:block>ID: <xsl:value-of select="@id"></xsl:value-of></fo:block>

                                <fo:block>STATUS: <xsl:value-of select="@status"></xsl:value-of></fo:block>

                                <fo:block>START: <xsl:value-of select="@start"></xsl:value-of></fo:block>

                                <fo:block>END: <xsl:value-of select="@finish"></xsl:value-of></fo:block>

                                <fo:block>DESCRIPTION: <xsl:value-of select="@description"></xsl:value-of></fo:block>
