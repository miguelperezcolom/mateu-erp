                            ...
                            <fo:table-body>
                                <fo:table-row>
                                    <fo:table-cell border-bottom-style="solid" border-right-width="1px" padding="1mm">
                                        <fo:block font-weight="700" font-size="12pt">Manifiesto excursión<fo:inline font-size="9pt" font-style="italic" font-weight="normal">EVENT MANIFEST</fo:inline></fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                            </fo:table-body>
                        </fo:table>
