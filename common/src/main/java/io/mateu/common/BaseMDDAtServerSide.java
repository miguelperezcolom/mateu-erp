...
import io.mateu.common.model.population.Populator;
 ...
 */
public class BaseMDDAtServerSide extends BaseServerSideApp implements ServerSideApp {
        ...
        Helper.transact(new JPATransaction() {
            ...
            public void run(EntityManager em)throws Throwable {
                ...
                if (u != null) {
                    ...
                    if (!Helper.md5(password.trim()).equalsIgnoreCase(u.getPassword().trim())) {
